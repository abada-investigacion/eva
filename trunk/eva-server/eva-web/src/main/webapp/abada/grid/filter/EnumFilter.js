 ...
 *
 */
Ext.define('Abada.grid.filter.EnumFilter', {
    extend: 'Ext.ux.grid.filter.Filter',
    alias: 'gridfilter.enum',
...
filter : [{"type":"list","value":"small,medium","field":"size"}]
    ...
    getSerialArgs : function () {
        return {type: 'enum', value: this.phpMode ? this.getValue().join(',') : this.getValue(),enumType:this.enumType};
    },
